    ...
    try:
        if loc_id_selected:
            ...
            if loc_id.startswith("LOC"):
                ...
                selected_address = f"Selected: {loc_id}" # Placeholder, might get updated from details
            else:
            ...
            if search_input.upper().startswith("LOC"):
                ...
                valid_suggestions = [
                    s for s in address_raw_json.get("suggestions", [])
                ...
                if len(valid_suggestions) == 0:
                    ...
                    loc_id = None # Don't proceed to details yet, wait for user selection
        ...
        elif not is_loc_id_search and not error_message and not suggestions_list and not loc_id_selected:
